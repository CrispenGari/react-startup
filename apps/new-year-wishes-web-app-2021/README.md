...
This is a simple frontend web app that wishes "Happy New Year" to all my friends! 💕
This application gives you 5 seconds to answer a question about Crispen as your friend.
...
```
yarn add @material-ui/icons @material-ui/core @material-ui/lab
```

### installation of `material-ui` using `npm`

```
npm add @material-ui/icons @material-ui/core @material-ui/lab
```

### installation of `react-icons` using `yarn`

```
yarn add react-icons
```

### installation of `react-icons` using `npm`
...
`$ cd new-year-wishes-web-app-2021`
...
URL: [test application online](https://happy-new-year-web-app-2021.web.app/)
